...
head(totalProp)
```
The table shows that tornados cause the most economic damage, followed by flash floods and high winds associated with thunderstorms. 
```{r}
...
Public health damage from severe weather events is shown in the following table. 
